  ...
  return (
    <div className="Home">
      ...
      <section
        ...
        className="container offer-area"
      >
        <div>
          <img
            style={{ cursor: "pointer" }}
      ...
      >
        <div>
          <img
            ...
            onClick={() => navigate("/products")}
            className="offer-area-img"
            src="https://1557691689.e.cdneverest.net/fast/2826x0/filters:format(webp)/static.5sfashion.vn/storage/home/collect/n8tqqsRGYEn83ZYVugJgNylzfVvDjlXa.jpg"
          />
        </div>
      </section>
      <div className="col-lg-12  container ">
        <div class="main_title">
          <h2>
            <span>Outfit năng động hè 2024</span>
          </h2>
          <p>Bạn sẽ không thất vọng khi lựa chọn</p>
        </div>
        <div className="products row d-flex flex-wrap">
          {products?.data
            ?.filter((product) => product.type === "Outfit")
            .slice(0, 8)
            .map((product) => {
              return (
                <CartComponents
